...
public class Mapel extends javax.swing.JInternalFrame {
    ...
    public void tampilData() {
        ...
        try {
            ...
            while(res.next()) {
                ...
                String nama_mata_pelajaran = res.getString("nama_mata_pelajaran");
                String [] data = {
                    kode_mata_pelajaran,
                    nama_mata_pelajaran
                };
    ...
    public void reset() {
        textKodeMapel.setText("");
        textNamaMapel.setText("");
    }
    ...
    private void initComponents() {
        ...
        textKodeMapel = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        jLabel3 = new javax.swing.JLabel();
        textNamaMapel = new javax.swing.JTextField();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(textKodeMapel, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
                                    .addComponent(textNamaMapel))
                                .addGap(50, 50, 50)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(textKodeMapel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))
                        .addGap(21, 21, 21)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(textNamaMapel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        String kodeMapel = "", namaMapel = "";
        kodeMapel = textKodeMapel.getText();
        namaMapel = textNamaMapel.getText();
        
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "INSERT INTO mata_pelajaran VALUES('"+ kodeMapel +"', '"+ namaMapel +"')";
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "DELETE FROM mata_pelajaran WHERE kode_mata_pelajaran = '"+ kodeMapel +"' ";
            PreparedStatement pst = (PreparedStatement)konek.prepareStatement(sql);
            pst.executeUpdate();
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "UPDATE mata_pelajaran set nama_mata_pelajaran = '"+ namaMapel +"' WHERE kode_mata_pelajaran = '"+ kodeMapel +"' "; 
            PreparedStatement pst = (PreparedStatement)konek.prepareStatement(sql);
            pst.executeUpdate();
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        textKodeMapel.setText(tabel.getValueAt(tabelMapel, 0).toString());
        textNamaMapel.setText(tabel.getValueAt(tabelMapel, 1).toString());
    ...
    private javax.swing.JTextField textKodeMapel;
    private javax.swing.JTextField textNamaMapel;
