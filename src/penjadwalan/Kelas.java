...
public class Kelas extends javax.swing.JInternalFrame {
    ...
    public void tampilData() {
        ...
        try {
            ...
            while(res.next()) {
                String kode_mata_pelajaran = res.getString("kode_kelas");
                String nama_mata_pelajaran = res.getString("nama_kelas");
                String [] data = {
                    kode_mata_pelajaran,
                    nama_mata_pelajaran
                };
    ...
    public void reset() {
        textKodeKelas.setText("");
        textNamaKelas.setText("");
    }
    ...
    private void initComponents() {
        ...
        textKodeKelas = new javax.swing.JTextField();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(textKodeKelas, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(textKodeKelas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))
                        .addGap(21, 21, 21)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        kodeKelas = textKodeKelas.getText();
        namaKelas = textNamaKelas.getText();
        
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "INSERT INTO kelas VALUES('"+ kodeKelas +"', '"+ namaKelas +"')";
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "DELETE FROM kelas WHERE kode_kelas = '"+ kodeKelas +"' ";
            PreparedStatement pst = (PreparedStatement)konek.prepareStatement(sql);
            pst.executeUpdate();
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        try {
            Connection konek = new Koneksi().getConnection();
            String sql = "UPDATE kelas set nama_kelas = '"+ namaKelas +"' WHERE kode_kelas = '"+ kodeKelas +"' "; 
            PreparedStatement pst = (PreparedStatement)konek.prepareStatement(sql);
            pst.executeUpdate();
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        textKodeKelas.setText(tabel.getValueAt(tabelMapel, 0).toString());
        textNamaKelas.setText(tabel.getValueAt(tabelMapel, 1).toString());
    ...
    private javax.swing.JTextField textKodeKelas;
